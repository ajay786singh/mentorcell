	...
	function widget( $args, $instance ) {
        ...
        foreach($social_values as $key=>$social_status){
        	if( $social_values[$key]){
        		if($key =='email_id') {
        			$socials[] = '<a target="'. $target.'" class="toptip" title="'. $this->social_list[$key].'" href="mailto:' . ot_get_option($key) . '"><i class="fa '.$this->social_icon_names[$key].'"></i></a>';

        		} else {
        			$socials[] = '<a target="'. $target.'" class="toptip" title="'. $this->social_list[$key].'" href="' . ot_get_option($key) . '"><i class="fa '.$this->social_icon_names[$key].'"></i></a>';
        		}
