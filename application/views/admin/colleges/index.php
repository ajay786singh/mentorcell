              ...
              <tbody>
				...
				<?php foreach($college_lists as $college_list){ ?>
				  <tr>
					...
					<a title="Edit" href="<?php echo base_url()."admin/colleges/edit/".$college_list['id'];?>">
					<i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> |
					<a title="Delete" href="<?php echo base_url()."admin/colleges/delete/".$college_list['id'];?>">
					<i class="fa fa-trash" aria-hidden="true"></i></a> |
					<a title="Add Gallry" href="<?php echo base_url()."admin/colleges/gallery/".$college_list['id'];?>">
					<i class="fa fa-picture-o" aria-hidden="true"></i></a> |
					<a title="Courses" href="<?php echo base_url()."admin/colleges/course/".$college_list['id'];?>">
					<i class="fa fa-book" aria-hidden="true"></i></a> |
					<a title="Assign Courses" href="<?php echo base_url()."admin/colleges/assigncourse/".$college_list['id'];?>">
