                        ...
                        <div class="col-md-12">
                             <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?php echo 'Update Logo'; ?></h3>
                                </div>
                                <div class="box-body">
                                    <?php echo $message;?>
									...
									?>
										...
										<div class="form-group">
										  ...
										  <div class="col-sm-10">
										  <input type="text" required="" class="form-control"  name="college_url" id="college_url" value="<?php echo @$college_url['value']?>" placeholder="Enter College Url">
										  </div>
										</div>
