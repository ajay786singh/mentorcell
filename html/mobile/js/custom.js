...
$('.mobileOverlay').click(function(){
  ...
  $('#mobileNavigation .mobileMain').removeClass('overflow');
  $('#mobileNavigation .mobSubmenu1').removeClass('active');
  $('#mobileNavigation .mobSubmenu2').removeClass('active');


});

$('.mobileLinksWidget ul li a.subLinks').click(function(){
  $('#mobileNavigation .mobileMain').addClass('overflow');
  $('#mobileNavigation .mobSubmenu1').addClass('active');
});

$('.mobSubmenuMiddle ul li a.subLinks').click(function(){
  $('#mobileNavigation .mobSubmenu2').addClass('active');
});

$('.mobSubmenu2 .mobSubmenuTop').click(function(){
  $('#mobileNavigation .mobSubmenu2').removeClass('active');
});

$('.mobSubmenu1 .mobSubmenuTop').click(function(){
  $('#mobileNavigation .mobSubmenu1').removeClass('active');
  $('#mobileNavigation .mobileMain').removeClass('overflow');
});
