...
<div class="youTubePlayer">
<?php
	$counselling_video1 = $this->common_model->get_all_rows("mc_counceling_video", "status",1);
		//print_r($counselling_video1);
...
?>
<a class="various fancybox fancybox.iframe" href="<?php echo base_url()."upload/".$counselling_video1[1]['video'];?>">
<video width="320" height="240" controls>
    <source src="<?php echo base_url()."upload/".$counselling_video1[1]['video'];?>">
</video>
</a>
...
<a href="<?php echo base_url()?>index.php/home/gallery" class="viewAll">View All Videos</a>
<ul>
<?php foreach($counselling_video1 as $video){
	//$video_image = 'https://img.youtube.com/vi/'.$video.'/default.jpg';
	//$video_url = 'https://www.youtube.com/embed/'.$video.'?autoplay=1'; ?>
	<li><a class='various fancybox fancybox.iframe' href='<?php echo base_url()."upload/".$video['video'];?>'>
...
<div class="row">
<div class="containerBox">
<div class="sectionHeading whiteColor"><span>Popular</span> Courses</div>
