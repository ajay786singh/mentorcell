...
class Course_detail extends Admin_Controller {
	...
	{ 
        ...
        { 
            ...
            /* Load Template */
				$this->data['course_description_page_name_list'] = $this->course_detail_model->get_all("mc_course_description");
				
				
            	$this->template->admin_render('admin/courses_description/index', $this->data);
        }
	}
