...
<!--side form start-->
      <form>
			  ...
			  <div class="form-style col-md-12">
               <div class="sectionHeading sec2"><p><span class="cont-head">Call Me </span>Back </p></div>
			  <span class="mobile-no"> <p>9899772211</p></span>
               ...
               <div class="form-style col-md-12">
               <input type="email" class="form-control" name="name" placeholder="Enter your ID" id="your-email">
               </div>
