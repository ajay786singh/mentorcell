...
class ht_wide_ads extends WP_Widget {
	...
	public function __construct() {
			global  $theme_name;
			$widget_ops = array('classname' => 'ht_wide_ads',
							'description' => __( 'Displays 6 300x280 ads blocks','highthemes') );
			parent::__construct(
				'ht_wide_ads', 
				'Highthemes - ' . __('Custom Ads 300x280','highthemes'), 
				 $widget_ops // Args
			);
	}
