...
<div class="couponHolder">
	<div class="couponRow" style='display:block;display: block;
    background-image: url(http://ec2-35-154-95-127.ap-south-1.compute.amazonaws.com/assets/theme/images/counselling.jpg);
		...
		<div class="regForm">
			...
			<form id="register_form">
				...
				<label>College Name</label><br>
					<input type="text" id="register_fname" required='' placeholder="Institute of Technology and Science" name="">
