                                ...
                                <div class="box-body">
                                    ...
                                    <?php echo form_open_multipart(uri_string(), array('class' => 'form-horizontal', 'id' => 'form-edit_college')); ?>
										...
										<div class="form-group">
										  ...
										  <div class="col-sm-10">
										  <textarea class="form-control" name="conveyer_quota" placeholder="For Conveyer Quota"><?php echo @$conveyer_quota['value']; ?></textarea>
										  </div>
										</div>
										...
										<div class="form-group">
										  ...
										  <div class="col-sm-10">
										 <textarea class="form-control" name="management_quota" placeholder="For Management Quota"><?php echo @$management_quota['value']; ?></textarea>
										  </div>
										</div>
										...
										<div class="form-group">
										  ...
										  <div class="col-sm-10">
										   <textarea class="form-control" name="international_quota" placeholder="For International Quota"><?php echo @$international_quota['value']; ?></textarea>
										  </div>
										</div>
