...
?>
            ...
            <!-- /.box-header -->
				 <div class="box-body">
					...
					<form action="<?php echo site_url('admin/colleges/save_updateassigncourses'); ?>" method="post" class="form-horizontal" id="form-create_stream">
					...
					<div class="form-group">
					 ...
					 <select  class="form-control clg_stream_id" name="clg_course_status" id="streams" >
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-10">
						  <input type="text" class="form-control"  name="coursetitle" id="coursetitle" value="<?=$course_assigndata['title']; ?>" placeholder="Enter Course Title">
						  </div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-10">
						  <input type="text" class="form-control"  name="fee" id="fee" value="<?php echo $course_assigndata['fee']; ?>" placeholder="Enter Course Fee">
						  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-10">
						  <input type="number" class="form-control" name="incentive" id="incentive" value="<?php echo $course_assigndata['incentive']; ?>" placeholder="Enter Course Incentive">
						  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-10">
						  <input type="text" class="form-control"  name="procedure" id="procedure" value="<?php echo $course_assigndata['procedure']; ?>" placeholder="Enter procedure">
						  </div>
						</div>
						<div class="form-group">
						  <label for="exampleInputEmail1" class="col-sm-2 control-label">College eligibility</label>
						  <div class="col-sm-10">
						  <input type="text" class="form-control" name="eligibility" id="eligibility" value="<?php echo $course_assigndata['eligibility']; ?>" placeholder="Enter eligibility">
						  </div>
						</div>
						...
						<?php $exams_name = $this->exam_model->get_exams_by_course($course_assigndata['stream_id']); ?>
						  ...
						  <div class="col-sm-10">
						   <?php if(!empty($course_assigndata['exam'])){
	 $exam = explode(",",$course_assigndata['exam']); ?>
	 <input class="form-control" <?php for($i=0;$i<count($exam);$i++){ $exam_detail = $this->college_model->get_single_exam_detail($exam[$i]); ?>
value="<?php echo $exam_detail->exam_name; ?>,"<?php } ?> ></br>
			...
			echo "<option value='0'>-- Choose Exam --</option>";
							...
							<div class="col-sm-offset-2 col-sm-10">
								<div class="btn-group">
									...
									<input type="hidden" class="ignoreField" value="<?=$assigned_id?>" name="assigned_id" id="assigned_id">
								
									<?php echo form_button(array('type' => 'submit', 'id' => $college_id, 'class' => 'updateassign_courses1 btn btn-primary btn-flat', 'content' => lang('actions_submit'))); ?>
								</div>
