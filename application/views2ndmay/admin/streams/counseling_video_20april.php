          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  <td><img src="<?php echo base_url()."upload/".$counceling_video['video'];?>" width="150px;" /></td>
				  <td><?php echo $counceling_video['title'];?></td>
                  <td><?php echo ($counceling_video['status']==1)?"Active":"Inactive";?>   </td>
                  <td><a href="<?php echo base_url()."admin/streams/edit/".$counceling_video['id'];?>">Edit</a> | <a href="<?php echo base_url()."admin/streams/delete/".$counceling_video['id'];?>">Delete</a></td>
               </tr>
               <?php }?>
                </tbody>
                <tfoot>
