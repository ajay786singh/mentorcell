                                ...
                                <div class="box-body">
									...
									?>
                                        ...
                                        <div class="form-group">
										  <label for="exampleInputEmail1" class="col-sm-2 control-label">Intake Name</label>
										  <div class="col-sm-10">
										  <input type="text" class="form-control" required="" name="name" id="name" value="<?php echo @$name['value']; ?>" placeholder="Enter Intake Name">
										  </div>
										</div>
