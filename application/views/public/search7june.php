...
$courid = $more_course[$i]['course_id'];
		...
		<h3 style="margin: 9px 0px 5px 0px;"><a style="color: #3757ab;" href="<?php echo base_url()."/home/search?course=".$courid;?>"><?=$morecoursedata->course_name?></a><span>0 Reviews</span></h3>
