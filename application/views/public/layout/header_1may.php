...
<?php 
 ...
 foreach($manage_main_courses as $manage_main){ ?>
	 <span class="sublinks"><a href="<?php echo base_url('course/index/course_detail/'.$manage_main["course_id"]); ?>"><?=$manage_main['course_name'];?></a></span>
	 <?php } 
 }
	 ?>
</div>
...
foreach($get_college1 as $college1){
	...
	foreach($manage_college_location1 as $college_location1){ ?>
		<span class="sublinks"><a href="<?php echo base_url('course/index/collge_detail/'.$college_location1["id"]); ?>"><?=$college_location1['name'];?></a></span>
	<?php }
}
 }
 ?>
...
$manage_college_location2 = $this->common_model->get_all_main_course("mc_colleges","id",$college2['college_id'],"featured_colleges","1");
	foreach($manage_college_location2 as $college_location2){ ?>
		<span class="sublinks"><a href="<?php echo base_url('course/index/collge_detail/'.$college_location2["id"]); ?>"><?=$college_location2['name'];?></a></span>
	<?php }
}
 }
 ?>
...
<?php 
 ...
 foreach($engineer_main_courses as $eng_main){ ?>
	 <span class="sublinks"><a href="<?php echo base_url('course/index/course_detail/'.$eng_main["course_id"]); ?>"><?=$eng_main['course_name'];?></a></span>
	 <?php } 
 } ?>
 </div>
</div>
...
foreach($get_college_eng1 as $college_eng1){
 $eng_college_location1 = $this->common_model->get_all_main_course("mc_colleges","id",$college_eng1['college_id'],"popular_colleges","1");
	foreach($eng_college_location1 as $college_location_eng1){ ?>
		<span class="sublinks"><a href="<?php echo base_url('course/index/collge_detail/'.$college_location_eng1["id"]); ?>"><?=$college_location_eng1['name'];?></a></span>
	<?php }
}
 }
 ?>
...
$eng_college_location2 = $this->common_model->get_all_main_course("mc_colleges","id",$college_eng2['college_id'],"featured_colleges","1");
	foreach($eng_college_location2 as $college_location_eng2){ ?>
		<span class="sublinks"><a href="<?php echo base_url('course/index/collge_detail/'.$college_location_eng2["id"]); ?>"><?=$college_location_eng2['name'];?></a></span>
	<?php }
}
 }
 ?>
...
<?php 
 ...
 foreach($design_main_courses as $design_main){ ?>
	 <span class="sublinks"><a href="<?php echo base_url('course/index/course_detail/'.$design_main["course_id"]); ?>"><?=$design_main['course_name'];?></a></span>
	 <?php } 
 } ?>
 </div>
</div>
...
<?php 
 ...
 foreach($medical_main_courses as $medical_main){ ?>
	 <span class="sublinks"><a href="<?php echo base_url('course/index/course_detail/'.$medical_main["course_id"]); ?>"><?=$medical_main['course_name'];?></a></span>
	 <?php } 
 } ?>
 </div>
</div>
...
<?php 
 ...
 foreach($science_main_courses as $science_main){ ?>
	 <span class="sublinks"><a href="<?php echo base_url('course/index/course_detail/'.$science_main["course_id"]); ?>"><?=$science_main['course_name'];?></a></span>
	 <?php } 
 } ?>
 </div>
</div>
...
<?php 
 ...
 foreach($hospital_main_courses as $hospital_main){ ?>
	 <span class="sublinks"><a href="<?php echo base_url('course/index/course_detail/'.$hospital_main["course_id"]); ?>"><?=$hospital_main['course_name'];?></a></span>
	 <?php } 
 } ?>
 </div>
</div>
...
<?php 
 ...
 foreach($low_main_courses as $low_main){ ?>
	 <span class="sublinks"><a href="<?php echo base_url('course/index/course_detail/'.$low_main["course_id"]); ?>"><?=$low_main['course_name'];?></a></span>
	 <?php } 
 } ?>
 </div>
</div>
...
<?php 
 ...
 foreach($mass_main_courses as $mass_main){ ?>
	 <span class="sublinks"><a href="<?php echo base_url('course/index/course_detail/'.$mass_main["course_id"]); ?>"><?=$mass_main['course_name'];?></a></span>
	 <?php } 
 } ?>
 </div>
</div>
...
<?php 
 ...
 foreach($commerce_main_courses as $commerce_main){ ?>
	 <span class="sublinks"><a href="<?php echo base_url('course/index/course_detail/'.$commerce_main["course_id"]); ?>"><?=$commerce_main['course_name'];?></a></span>
	 <?php } 
 } ?>
 </div>
</div>
