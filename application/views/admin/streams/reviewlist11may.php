...
$course_name = $this->common_model->get_single_var('course_name', 'mc_courses', 'course_id', $review['course_name']);
               ...
               <td><?php echo $review['email'];?></td>
                  <td><?php echo ($review['status']==1)?"Active":"Inactive";?>   </td>
                  <td><a href="<?php echo base_url()."admin/stream/viewreview/".$review['id'];?>">View</a> | <a href="<?php echo base_url()."admin/stream/deletereview/".$review['id'];?>">Delete</a></td>
               </tr>
               <?php }?>
                </tbody>
                <tfoot>
