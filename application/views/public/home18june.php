...
<button class="go"><span class="glyphicon glyphicon-search"></span></button>
	...
	<style>
	/**.careerCol blockquote::before{
    left: 22px;
    top: -16px;
	}**/
/**	.careerCol blockquote::after {
    right: 28px;
    top: 52px;**/
}
...
<div class="owl-carousel owl-theme" id="main-slider" style="float:left; margin-top:30px; margin-bottom:30px;">
    <div class="item"><img src="<?php echo base_url('assets/theme/images/250.jpg'); ?>"/></div>
    <div class="item"><img src="<?php echo base_url('assets/theme/images/300corusces.jpg'); ?>"/></div>
    <div class="item"><img src="<?php echo base_url('assets/theme/images/abroad_1.jpg'); ?>"/></div>
    <div class="item"><img src="<?php echo base_url('assets/theme/images/aadmision.jpg'); ?>"/></div>
    <div class="item"><img src="<?php echo base_url('assets/theme/images/bannerslide.jpg'); ?>"/></div>
    <div class="item"><img src="<?php echo base_url('assets/theme/images/career_1.jpg'); ?>"/></div>
    <div class="item"><img src="<?php echo base_url('assets/theme/images/scholarship_1.jpg'); ?>"/></div>
</div>
</div>
               ...
               <div class="row">
			    <div class="col-sm-6">
				 <div class="link-section">
				   <h2>Now</h2>
				   <h3>WE'RE ON <span class="mobile-col">MOBILE</span> TOO</h3>
				   <Form>
				     <label>Text for the link to download the mentorcell App</label><br>
					 <input type="text" name="link" id="link-form" placeholder="e.g.212 323 4545">
					 <button type="button" id="btn-link-style">GET LINK</button><br>
					 <div class="app-img .img-responsive">
					 <img src="<?php echo base_url('assets/theme/images/gg.jpg'); ?>" alt="app">
					 </div>
				   </form>
				...
				<div class="col-sm-6">
				  <div class="mobile-img">
				    <img src="<?php echo base_url('assets/theme/images/mobile.jpg'); ?>" alt="mobile-img" class="img-responsive">
				  </div><!--end of mobile-img-->
				</div>
