  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
   ...
   <div id="back">
      ...
      <div class="content-box">
          ...
          <P>Educations.com has a wide variety of different education levels including diplomas, bachelors degrees, masters degrees, doctorates and PhD courses, distance learning and summer courses. Good luck with finding your future education abroad.</P>
            ...
            <div class="top-head">
			  ...
			  <div class="form-group col-md-6">
               ...
               <select class="form-control" name="country" id="country">
				 ...
				 <?php
					$countries = $this->common_model->get_all_rows("countries", 1,1);
