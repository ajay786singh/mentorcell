...
<!--side form start-->
      <form>
			  ...
			  <div class="form-group col-md-12">
               <p><span class="cont-head">Call Me </span>Back <span id="from-close">x</span></p>
			   <p>9899772211</p>
               </div>
               ...
               <div class="form-group col-md-12">
               <input type="email" class="form-control" name="name" placeholder="Enter your ID" id="email">
               </div>
