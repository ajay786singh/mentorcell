...
?>
    <div class="ht-options-video">
        ...
        <p>
            ...
            <input style="width:100%;" id="<?php echo $this->get_field_id("video_url"); ?>" name="<?php echo esc_attr($this->get_field_name("video_url")); ?>" type="text" value="<?php echo esc_url($instance["video_url"]); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id("video_embed_code")); ?>"><?php _e('Video Embed Code', 'highthemes'); ?></label>
            <textarea class="widefat" id="<?php echo $this->get_field_id('video_embed_code'); ?>" name="<?php echo esc_attr($this->get_field_name('video_embed_code')); ?>"><?php echo esc_textarea($instance["video_embed_code"]); ?></textarea>
        </p>
    </div>
    <?php
    }
