				 ...
				 <div class="box-body">
					...
					<div class="form-group">
						...
						<div class="form-group">
										  ...
										  <div class="col-sm-10">
										  <textarea class="form-control" id="conveyer_quota" name="conveyer_quota"><?=$course_assigndata['conveyer_quota']; ?></textarea>
										  </div>
										</div>
			...
			echo "<option value='0'>-- Choose Exam --</option>";
							...
							<div class="col-sm-offset-2 col-sm-10">
								<div class="btn-group">
									...
									<?php echo form_button(array('type' => 'submit', 'id' => 'updateassign_courses', 'class' => 'btn btn-primary btn-flat', 'content' => lang('actions_submit'))); ?>
								</div>
